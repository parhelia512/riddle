...
It targets IntelliJ Platform 2026.1 or newer. IntelliJ IDEA editions are supported; Android Studio is not a supported target.

Use JDK 25 or newer for the Gradle JVM, make sure `riddle-lsp` is available in the IDE process `PATH`, then build the plugin:
